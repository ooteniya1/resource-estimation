...
[Openshift Monitoring[(https://docs.openshift.com/container-platform/4.7/monitoring/understanding-the-monitoring-stack.html)] and the installed VPA CR will be used to monitor the resource usage.
